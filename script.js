...
sidenav.innerHTML = "Welcome<br> To <br>Brewery DB"
sidenav.style.fontSize="30px"
...
<button onclick="next()">Next</button><button type="button" onclick="previous()>NEXT</button>`
...
searchE.setAttribute("class","form-row");
let formrow = document.createElement("div");
formrow.setAttribute("class","col");
let  input= document.createElement("input");
input.setAttribute("type","text");
input.setAttribute("class","form-control");
let butt=document.createElement("div");
butt.setAttribute("type","button");
butt.setAttribute("class","btn btn-secondary btn-lg");
butt.innerHTML="Search";
butt.style.marginLeft="10px"
butt.style.width="95px"
...
searchE.append(formrow,butt);
header.append(searchE);
